...
/*--------------------------------------------------- FIX VARIATION --------------------------------------------------*/
    let filename_red = '../static/xiangjun1.csv';
/*--------------------------------------------------- FIX VARIATION --------------------------------------------------*/
    ...
    d3.csv(filename_red).then(function(loadedData){
        ...
        for (let i = 0; i < loadedData.length; i++ ) {
            ...
            var roi = (loadedData[i].ROI).replace("%","");     //remove % 
        ...
        for (let i = 0; i < loadedData.length; i++ ) {
            let date = loadedData[i].DATE;
            var hushen = (loadedData[i].HUSHEN).replace("%",""); //remove %
...
let reddata_backgroundcolor = window.myLine.datasets[1].data;
for (let i = 0; i < reddata_backgroundcolor.length; i++) {
    if (reddata_backgroundcolor[i] < 0){
        reddata_backgroundcolor[i].backgroundColor = 'white';
    }
}
.................................*/
